...
const About = () => {
  ...
  return (
    <>
      <section className="flex justify-center text-theme-primary px-4 sm:px-6 lg:px-8 items-center">
        <div className="w-4/5 flex flex-col lg:flex-row gap-8 lg:gap-10">
          <div
            ref={leftRef}
            className="lg:w-1/2 space-y-4 sm:space-y-6  text-left reveal"
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-theme-primary">
              {aboutContent.heading}
            </h2>

            <p className="text-theme-secondary leading-relaxed text-sm sm:text-2xl">
              {aboutContent.intro}
            </p>
          ...
          <div
            ref={rightRef}
            className="lg:w-1/2 flex flex-col justify-center reveal"
          >
            <div className="w-full max-w-sm sm:max-w-md bg-theme-muted/10 flex items-center justify-center  overflow-hidden">
              <img
                src={"/dp.png"}
