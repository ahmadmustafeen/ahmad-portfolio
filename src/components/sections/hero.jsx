...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="w-full  bg-[linear-gradient(rgba(0,0,0,0.9),rgba(0,0,0,0.6)),url('/bg.jpg')] min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24"
    >
      <div className="max-w-5xl w-full flex flex-col items-start relative lg:ml-[250px]  lg:mb-[70px]">
        <div className="w-full">
          ...
          <div className="relative flex items-center">
            ...
            <div className="shrink-0 relative z-10" ref={iconBoxRef}>
              <PlusIcon
                className="text-gray-500 opacity-90 w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20"
                strokeWidth={3.2}
              />
            </div>
            ...
            <div className="relative inline-block text-4xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-[90px] font-bold text-theme-primary leading-none overflow-visible">
              <span
                ref={skillRef}
                key={skills[index]}
                className="relative z-10 pl-2 animate-skillFade"
              >
                {skills[index]}
              </span>
            </div>
